...
import AZNLogo from "@/public/images/logo.png";

export const Logo: React.FC<ImageProps> = ({ width, height, ...props }) => (
  // <svg
  //   fill="none"
  //   height={size || height}
  //   viewBox="0 0 32 32"
  ...
  //   />
  // </svg>
  <Image {...props} width={width} src={AZNLogo} alt="AZN Logo"></Image>
);
...
export const FlameIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
